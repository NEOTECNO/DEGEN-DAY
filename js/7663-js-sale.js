...
const mint = async (e)=> {
    ...
    if (_mintAmount > 0) {
			...
			try {
			  ...
			  console.log("Error: ",e);
			  document.getElementById("tokens_available").innerHTML = totalSupply + "/" + "690";
			  }
		}
	}
}
